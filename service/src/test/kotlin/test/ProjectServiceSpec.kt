...
class ProjectServiceSpec @Autowired constructor(
    ...
    fun createProjectOK() {
        ...
        result.state shouldBe ProjectState.RECRUITING
    ...
    fun findProjectNoticeThreadNotFoundOK() {
        ...
        threadDeletedResult.state shouldBe createdProject.state
    ...
    fun searchOK() {
        ...
        val result = projectService.search(
            ...
            stackId = null,
            position = null,
            pageable = PageRequest.of(100, 100)
        )
    ...
    fun updateProjectTaskNotFoundException() {
        ...
        shouldThrowExactly<DataNotFoundException> {
            projectService.updateProject(
                ...
                command = DefaultCommand.CreateProject.let {
                    UpdateProject(
                        title = "Changed Title",
